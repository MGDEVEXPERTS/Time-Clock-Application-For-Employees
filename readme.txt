...
Thank you for purchasing PHP Employee Time Management System. 

PHP Employee Time Management System. is a time clock application based on Laravel and PHP, designed for a time and attendance system, time tracking, employee time clock, and timekeeping application.

If you have any question about Workday please feel free to contact with us. 
If you need support, customization or feature request, you may email to us at hello@mgdevexperts.com
...
1. Unzip the Download file from MG DEV EXPERTS Github Respo. You will find two folders, one folder contains Documentation & another is Application Files.
...
4. Import database from /Application/database/ folder named current_database.sql to your database server. Create a database user and grant all necessary privileges to the database on your server.
...
### If you need technical support or feature request, you may email to us at hello@mgdevexperts.com